...
public class GamePlay extends JPanel implements KeyListener, ActionListener {
	...
	private int[] fruitXpos = { 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450,
			475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 800, 825, 850 };
	...
	public void paint(Graphics g) {
		...
		// score y tamaño de serpiente
		g.setColor(Color.white);
		g.setFont(new Font("area1", Font.PLAIN, 14));
		...
		for (int i = 1; i < lengthofsnake; i++) {
			if (snakeXlength[i] == snakeXlength[0] && snakeYlength[i] == snakeYlength[0]) {
				...
				g.setFont(new Font("area1", Font.BOLD, 40));
				g.drawString("Game Over! Score: " + score, 250, 300);

				g.setColor(Color.WHITE);
				g.setFont(new Font("area1", Font.BOLD, 40));
				g.drawString("Press Enter to restart" + score, 350, 340);
			}
		}
		g.dispose();
	}
